...
const RoomsCard = ({ roomsPromise }) => {
  const rooms = use(roomsPromise);
  const [currentImageIndices, setCurrentImageIndices] = useState({});

  // Dynamic carousel navigation (works for any number of images)
        ...
        return (
          ...
          >
            ...
            <div className="relative h-56 bg-gray-200 overflow-hidden">
              ...
              {/* Carousel Controls */}
              <button
                onClick={() => handlePrevImage(room._id, totalImages)}
              ...
              <button
                onClick={() => handleNextImage(room._id, totalImages)}
              ...
              <div className="absolute bottom-3 left-0 right-0 flex justify-center space-x-2">
                {images.map((_, index) => (
                  <button
                    key={index}
                    onClick={() =>
                      setCurrentImageIndices(prev => ({ ...prev, [room._id]: index }))
                    }
            ...
            <div className="p-5">
             ...
             <Link to={`/rooms/${room._id}`}>
              <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-xl shadow-lg transition-all duration-300 flex items-center justify-center group">
                <span className="group-hover:scale-105 transition-transform duration-300">See Details</span>
