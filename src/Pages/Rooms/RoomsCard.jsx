...
const RoomsCardHorizontal = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen lg:mx-10 bg-gray-50 dark:bg-gray-900">
      ...
      <div
        className={`${
          ...
          fixed lg:sticky top-0 left-0 w-55 lg:w-95 h-screen bg-white dark:bg-gray-800 shadow-lg lg:shadow-sm z-40
          overflow-y-auto border-r border-gray-200 dark:border-gray-700 rounded-2xl mt-3.5 mb-4`}
      >
        {/* Map Section */}
            ...
            {rooms.map((room) => {
              ...
              return (
                <Link
                  to={`/rooms/${room._id}`}
                  key={room._id}
                  className="block w-full ml-0 mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-700 overflow-hidden hover:shadow-lg dark:hover:shadow-gray-600 transition-shadow duration-300 flex flex-col md:flex-row"
                >
                  {/* Image Section */}
                    ...
                    {totalImages > 1 && (
                      <>
                        <button
                          ...
                          className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 dark:bg-gray-700/80 hover:bg-white dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full p-2 shadow-md transition-all duration-200"
                        >
                          <FiChevronLeft className="h-4 w-4" />
                        </button>
                        <button
                          onClick={(e) => handleNextImage(room._id, totalImages, e)}
                          className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 dark:bg-gray-700/80 hover:bg-white dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-full p-2 shadow-md transition-all duration-200"
                        >
                          ...
                          {images.map((_, index) => (
                            <button
                              ...
                              className={`h-2 rounded-full transition-all duration-200 ${
                                currentIndex === index
                                  ? "bg-white dark:bg-gray-300 w-4"
                                  : "bg-white/50 dark:bg-gray-600 w-2"
                              }`}
                            />
                          ))}
                        </div>
                  ...
                  <div className="p-6 md:w-3/5">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center bg-blue-100 dark:bg-blue-900 px-3 py-1 rounded-full">
                        ...
                        <FiStar className="ml-1 text-blue-800 dark:text-blue-300" size={14} />
                      </div>
                    </div>
                    ...
                    {/* Location */}
                    <div className="flex items-start mt-3 text-gray-600 dark:text-gray-400">
                      <FiMapPin className="mr-1 mt-0.5 flex-shrink-0" size={14} />
                      <span className="text-sm">
                        {room.location}
                        <Link to="/map" className="text-blue-500 dark:text-blue-400 ml-1 hover:underline">
                          Show on Map
                        </Link>
                      </span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                      <div className="mb-3 sm:mb-0">
                        <p className="text-gray-500 dark:text-gray-400 text-sm">Price per night</p>
                        <div className="flex items-center">
                      ...
                      <div className="flex items-center bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300 w-full lg:w-auto text-center justify-center cursor-pointer">
                    ...
                    {id && reviews.length > 0 && (
                      <div className="mt-4">
                        <h4 className="font-semibold text-gray-800 dark:text-gray-200">Guest Reviews</h4>
                        <div className="space-y-3 mt-2">
                          {reviews.map(review => (
                            <div key={review._id} className="border-t border-gray-200 dark:border-gray-700 pt-3">
                              <div className="flex items-center">
                              ...
                              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">- {review.userName}</p>
                            </div>
                          ))}
                        </div>
                      </div>
