...
import { FiMapPin, FiCalendar, FiCheck, FiStar, FiChevronLeft, FiChevronRight, FiWifi } from 'react-icons/fi';
            ...
            <div className="bg-white p-6 md:p-8 rounded-b-2xl shadow-xl">
                <div className="flex flex-col md:flex-row justify-between">
                    ...
                    <div className="mt-4 md:mt-0 bg-blue-50 border border-blue-100 rounded-xl p-4 w-full md:w-64">
                        ...
                        <button className="w-full mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-lg shadow-md transition-all duration-300">
                            Book Now
                        </button>
